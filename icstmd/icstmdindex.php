...
/**
 *	\file       htdocs/icstmd/template/icstmdindex.php
 *	\ingroup    icstmd
 *	\brief      Home page of icstmd top menu
 */
...
$langs->loadLangs(array("icstmd@icstmd"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->icstmd->read) accessforbidden();
...
llxHeader("",$langs->trans("icstmdArea"));

print load_fiche_titre($langs->trans("icstmdArea"),'','icstmd.png@icstmd');
...
// Draft MyObject
if (! empty($conf->icstmd->enabled) && $user->rights->icstmd->read)
{
	$langs->load("orders");
